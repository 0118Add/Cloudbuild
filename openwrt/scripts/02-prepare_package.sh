...
# autoCore
git clone https://$github/8688Add/autocore-arm -b openwrt-23.05 package/new/autocore
...
rm -rf package/new/helloworld/{luci-app-passwall,luci-app-passwall2,luci-app-homeproxy}
